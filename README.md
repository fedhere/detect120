...
__1 -  First off: You need to decide what is a source. Generally that starts with stacking images to get a deep enought image of the night skyline.__ Use **stackImages.py**. For example:
...
!(https://github.com/fedhere/detect120/tree/master/pipeline/stacks/groundtest1/ESB_c0.7Hz_250ms_2016-05-24-230354_N20.png " scene stack")

!(https://github.com/fedhere/detect120/tree/master/pipeline/stacks/groundtest1/ESB_c0.7Hz_250ms_2016-05-24-230354_N20_labelledwindows.png "scene windows")
...
-**ESB_s119.75Hz_c4.00Hz_100ms_2016-05-24-215440_phases.png**: the scene is plotted with the selected windows highlighted in color corresponing to the phase.
